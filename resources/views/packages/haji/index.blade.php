...
@section('title', 'Paket Haji - PT. Anihamid Group')

@section('content')
<!-- Page Header -->
<section class="bg-gradient-to-r from-green-600 to-green-800 text-white py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-4xl md:text-5xl font-bold mb-4">Paket Haji</h1>
        <p class="text-xl text-green-100">Wujudkan rukun Islam kelima dengan paket haji terpercaya</p>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        @if($packages->count() > 0)
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-xl transition-shadow">
                    ...
                    @else
                        <div class="w-full h-56 bg-gradient-to-r from-green-500 to-green-700 flex items-center justify-center">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center pt-4 border-t border-gray-200">
                            ...
                            <a href="{{ route('packages.haji.detail', $package->id) }}" class="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors">
                                Lihat Detail
                            </a>
                        </div>
                    </div>
        ...
        @else
            <div class="text-center py-16">
                ...
                <p class="text-gray-600">Paket haji akan segera hadir. Silakan hubungi kami untuk informasi lebih lanjut.</p>
            </div>
        @endif
    </div>
</section>
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-gray-600 mb-8">
            Tim kami siap membantu Anda menemukan paket haji yang sesuai dengan kebutuhan dan budget
        </p>
        <a href="https://wa.me/6281234567890?text=Assalamualaikum,%20saya%20ingin%20bertanya%20tentang%20paket%20haji" 
           target="_blank"
